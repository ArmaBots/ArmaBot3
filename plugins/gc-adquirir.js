...
> 🤖Si quieres que te atienda nuestro asistente comunicate al: +52 55 2576 2927🤖

Y si quieres que te atienda un creador  escríbe al numero:
Arm: +52 55 2730 5507
Arm2: +52 55 3293 3843

También puedes probar nuestro bot en este grupo:
> https://chat.whatsapp.com/BwbtuqKNy1IF6yHfjfFSaO`.trim()
await conn.sendFile(m.chat, gataImg, './Menu2.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' ArmaBot ', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu }}})
