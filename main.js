...
mobile: MethodMobile, 
browser: opcion == '1' ? ['ArmaBot', 'Edge', '20.0.04'] : methodCodeQR ? ['ArmaBot', 'Edge', '20.0.04'] : ["Ubuntu", "Chrome", "20.0.04"],
auth: {
creds: state.creds,
...
let prekey = []
let directorio = readdirSync("./ArmaBot")
...
const directories = ['./ArmaBot/', './GataJadiBot/']
